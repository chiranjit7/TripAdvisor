...
sentence_pairs = [
    ["The food is lovely and terrific value . Lots of variety for everyone . We would come again if we visit Ubu ", "in house restaurant serves delicious , well priced food", 0.000],
    ["John is very nice.", "Is John very nice?", 0.000],
...
for sent_pair in sentence_pairs:
    print "%s\t%s\t%.3f\t%.3f" % (sent_pair[0], sent_pair[1], sent_pair[2], similarity(sent_pair[0], sent_pair[1], True))
for sent_pair in sentence_pairs:
    print "%s\t%s\t%.3f\t%.3f" % (sent_pair[0], sent_pair[1], sent_pair[2], similarity(sent_pair[0], sent_pair[1], False))
